...
public class UserForm2 {
    ...
    private static void openResultForm(String name, String address, String level) {
        ...
        nameValue.setBounds(140, 30, 200, 25);
        
        JLabel addressLabel = new JLabel("Address:");
        addressLabel.setBounds(30, 70, 100, 25);
        JLabel addressValue = new JLabel(address);
        addressValue.setBounds(140, 70, 200, 25);
        
        JLabel levelLabel = new JLabel("Level:");
        levelLabel.setBounds(30, 110, 100, 25);
        JLabel levelValue = new JLabel(level);
        levelValue.setBounds(140, 110, 200, 25);
        
        resultFrame.add(nameLabel);
        resultFrame.add(nameValue);
        resultFrame.add(addressLabel);
        resultFrame.add(addressValue);
        resultFrame.add(levelLabel);
        resultFrame.add(levelValue);
